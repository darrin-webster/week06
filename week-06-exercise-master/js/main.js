...
//else else if < ORIGINAL ANSWER
//Apparently its else if if
...
// 	} else {
// 		return "Neither is nor else ran";
// 	};
// };
...
//not entirely sure what happened here but the code wouldnt run in the console
// expecting else if+elseif else
...
countVowels("I am the very model of a modern major general"); //vowels = 14
countVowels("Exeunt pursued by a bear"); //vowels = 9
countVowels("o123o"); //vowels = 2
